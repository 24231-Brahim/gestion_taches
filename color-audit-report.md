...
| **D** | Boutons `--color-cta` (clair) : blanc sur `#0d9488` = **3.74:1** → échoue **même en light**                                                                                                                                                                         | `.btn-primary`, `.btn-cta` (project.scss). `--color-cta-hover` (`#0f766e`) passe (5.47:1).                                                                                                                                                                                                              |
...
| `#ffffff` sur `--color-cta` (#0d9488)                 | 3.74               | ❌ (y compris **light**) | CTA → `#0f766e` + `--color-on-cta`        |
...
| 44-45 | `$link-color #0077cc`, `$link-hover-color #0097b2` | `--color-link` #0074c2 ; hover `--color-secondary` #0f766e |
...
```scss
--color-cta: #0f766e; /* remplace #0d9488 (blanc dessus 3.74 ❌) — blanc dessus 5.47 ✓ */
...
| CTA light                          | `#0d9488` (blanc 3.74:1 ❌)                                                                                                              | `#0f766e` (5.47:1 ✓), hover `#115e59` (7.58:1 ✓), `on-cta: #fff`                                                     |
