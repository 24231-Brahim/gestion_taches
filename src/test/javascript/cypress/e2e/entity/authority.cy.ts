...
describe('Authority e2e test', () => {
  ...
  let username: string;
  let password: string;
  const authoritySample = { name: '57736048-7825-4011-a0df-7af8881c4591' };
  ...
  describe('Authority page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Authority').should('not.contain', 'gestionTachesApp.adminAuthority.home.title');
    });
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('3e5e9141-cf5c-4eae-8d64-923e556b1bcb');
      cy.get(`[data-cy="name"]`).should('have.value', '3e5e9141-cf5c-4eae-8d64-923e556b1bcb');
