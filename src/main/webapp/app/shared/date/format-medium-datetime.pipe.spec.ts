...
describe('FormatMediumDatetimePipe', () => {
  const pipe = new FormatMediumDatetimePipe();
  ...
  it('should format a dayjs object', () => {
    expect(pipe.transform(dayjs('2020-11-16').locale('fr'))).toBe('16 Nov 2020 00:00:00');
  });

  it('should format an ISO string', () => {
    expect(pipe.transform('2020-11-16T14:30:00')).toBe('16 Nov 2020 14:30:00');
  });

  it('should format a Date object', () => {
    const date = new Date('2020-11-16T14:30:00');
    expect(pipe.transform(date)).toBe('16 Nov 2020 14:30:00');
  });
