...
describe('Attachment Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Attachment', () => {
      ...
      service.create(attachment).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Attachment', () => {
      ...
      service.update(attachment).subscribe(resp => (expectedResult = resp));
    ...
    describe('addAttachmentToCollectionIfMissing', () => {
      it('should add a Attachment to an empty array', () => {
        ...
        expect(expectedResult).toEqual([attachment]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([attachment, attachment2]);
      });
