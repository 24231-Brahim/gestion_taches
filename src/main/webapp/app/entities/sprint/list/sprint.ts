...
export class Sprint implements OnInit {
  ...
  readonly isLoading = this.sprintService.sprintsResource.isLoading;
  ...
  constructor() {
    effect(() => {
      const headers = this.sprintService.sprintsResource.headers();
      if (headers) {
        this.fillComponentAttributesFromResponseHeader(headers);
      }
    });
    effect(() => {
      this.sprints.set(this.fillComponentAttributesFromResponseBody([...this.sprintService.sprints()]));
    });
  ...
  protected fillComponentAttributesFromResponseBody(data: ISprint[]): ISprint[] {
    return data;
  }
  ...
  protected queryBackend(): void {
    ...
    this.sprintService.sprintsParams.set(queryObject);
  }
