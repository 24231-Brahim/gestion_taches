...
describe('Task Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    expect(comp.tasks()[0]).toEqual(expect.objectContaining({ id: 6256 }));
  });
  ...
  it('should calculate the filter attribute', () => {
    ...
    // THEN
    expect(service.tasksParams()).toMatchObject(expect.objectContaining({ 'someId.in': ['dc4279ea-cfb9-11ec-9d64-0242ac120002'] }));
  });
