...
describe('Comment Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Comment', () => {
      ...
      service.create(comment).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Comment', () => {
      ...
      service.update(comment).subscribe(resp => (expectedResult = resp));
    ...
    describe('addCommentToCollectionIfMissing', () => {
      it('should add a Comment to an empty array', () => {
        ...
        expect(expectedResult).toEqual([comment]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([comment, comment2]);
      });
