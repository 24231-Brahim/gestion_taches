...
import { EpicDeleteDialog } from './epic-delete-dialog';

describe('Epic Management Delete Component', () => {
  let comp: EpicDeleteDialog;
  let fixture: ComponentFixture<EpicDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EpicDeleteDialog);
