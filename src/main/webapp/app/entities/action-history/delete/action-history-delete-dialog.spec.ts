...
import { ActionHistoryDeleteDialog } from './action-history-delete-dialog';

describe('ActionHistory Management Delete Component', () => {
  let comp: ActionHistoryDeleteDialog;
  let fixture: ComponentFixture<ActionHistoryDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ActionHistoryDeleteDialog);
